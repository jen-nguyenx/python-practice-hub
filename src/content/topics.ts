...
export interface TopicMeta {
  ...
  /** Included by default in the mid-semester practice test. */
  midsem: boolean;
  note?: string;
}
...
export const TOPICS: readonly TopicMeta[] = [
  { id: 'variables-expressions', order: 1, num: '01', title: 'Variables, types and expressions', short: 'Variables', band: 'core',
    ...
    concepts: ['operators', 'types', 'conversion', 'f-strings'], unitRef: 'Lectures 3-4, 6 · Lab 01', minimum: { solve: 5, code: 1 }, midsem: true },
  { id: 'if-elif-else', order: 2, num: '02', title: 'If, elif, else and Boolean logic', short: 'Decisions', band: 'core',
    ...
    concepts: ['comparison', 'boolean', 'elif', 'in'], unitRef: 'Lectures 7-8 · Lab 03', minimum: { solve: 5, code: 2 }, midsem: true,
  ...
  { id: 'for-loops-range', order: 3, num: '03', title: 'For loops and range()', short: 'For loops', band: 'core',
    ...
    concepts: ['range', 'accumulator', 'trace', 'fibonacci'], unitRef: 'Lecture 5 · Lab 03', minimum: { solve: 6, code: 2 }, midsem: true },
  { id: 'functions-basics', order: 4, num: '04', title: 'Functions part 1', short: 'Functions', band: 'core',
    ...
    concepts: ['def', 'return', 'parameters', 'docstring'], unitRef: 'Lecture 9 · Lab 02', minimum: { solve: 5, code: 2 }, midsem: true },
  { id: 'strings', order: 5, num: '05', title: 'Strings', short: 'Strings', band: 'core',
    ...
    concepts: ['slicing', 'methods', 'immutability', 'palindrome'], unitRef: 'Lectures 10-11', minimum: { solve: 5, code: 2 }, midsem: true },
  { id: 'lists-tuples', order: 6, num: '06', title: 'Lists, tuples and sorting', short: 'Lists', band: 'core',
    ...
    concepts: ['list', 'tuple', 'sort', 'aliasing', 'nested-list'], unitRef: 'Lecture 12 · Lab 04', minimum: { solve: 6, code: 2 }, midsem: true },
  { id: 'while-nested-loops', order: 7, num: '07', title: 'While loops, nested loops and series', short: 'While loops', band: 'core',
    ...
    concepts: ['while', 'nested-loop', 'series', 'digits'], unitRef: 'Lectures 16-18', minimum: { solve: 6, code: 2 }, midsem: true },
  { id: 'dictionaries', order: 8, num: '08', title: 'Dictionaries', short: 'Dictionaries', band: 'core',
    ...
    concepts: ['dict', 'counting', 'grouping', 'ranking'], unitRef: 'Lectures 20-21 · Lab 05', minimum: { solve: 5, code: 2 }, midsem: false },
  { id: 'files-csv', order: 9, num: '09', title: 'Text files and CSV without imports', short: 'Files and CSV', band: 'late',
    ...
    concepts: ['open', 'split', 'header', 'validation'], unitRef: 'Lectures 13-14 · Projects', minimum: { solve: 4, code: 2 }, midsem: false },
  { id: 'exceptions', order: 10, num: '10', title: 'Exceptions and graceful termination', short: 'Exceptions', band: 'late',
    ...
    concepts: ['try', 'except', 'traceback', 'validation'], unitRef: 'Lecture 19 · Projects', minimum: { solve: 4, code: 1 }, midsem: false },
  { id: 'functions-project', order: 11, num: '11', title: 'Functions part 2 and the main() contract', short: 'Project rules', band: 'late',
    ...
    concepts: ['scope', 'defaults', 'main', 'rules'], unitRef: 'Lecture 15 · Project specs', minimum: { solve: 5, code: 2 }, midsem: false },
  { id: 'project-simulator', order: 12, num: '12', title: 'Project simulator', short: 'Project sim', band: 'late',
    ...
    concepts: ['statistics', 'nested-dict', 'ranking', 'csv'], unitRef: 'Projects 1 and 2', minimum: { solve: 3, code: 2 }, midsem: false },
  { id: 'recursion', order: 13, num: '13', title: 'Recursion', short: 'Recursion', band: 'late',
    ...
    concepts: ['base-case', 'call-stack', 'nested-list'], unitRef: 'Lectures 27-28 · Final exam', minimum: { solve: 5, code: 2 }, midsem: false,
