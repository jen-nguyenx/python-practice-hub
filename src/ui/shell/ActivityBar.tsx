// 52px icon bar down the left side (docs/build/DESIGN.md "Frame"): Topics, Lessons, Playground, Exams, Report, then Settings
...
export type NavKey = 'topics' | 'lessons' | 'playground' | 'tests' | 'report' | 'settings';
