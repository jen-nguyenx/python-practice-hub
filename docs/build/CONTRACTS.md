...
- The student has sat the mid-semester test. The app is now for **general Python study and final-exam practice**. Correctness and a working core beat extra polish.
